...
RUN DATABASE_URL="postgresql://postgres:postgres@postgres:5432/hostgodfrey?schema=public" \
...
RUN export NODE_ENV=production \
    DATABASE_URL="postgresql://postgres:postgres@postgres:5432/hostgodfrey?schema=public" \
